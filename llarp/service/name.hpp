    ...
    namespace service
    {
        /** Holds an entire ONS Record returned from a succfessful request to the `lookup_name` endpoint.
            ...
            bt-encoded keys:
                ...
                'n' : nonce
        */
        struct EncryptedONSRecord
        {
          private:
            explicit EncryptedONSRecord(std::string bt);
          ...
          public:
            ...
            EncryptedONSRecord() = default;

            static std::optional<EncryptedONSRecord> construct(std::string bt);
